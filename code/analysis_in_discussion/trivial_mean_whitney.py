...
def analyze_priority_data_vs_baseline(filepath, baseline_group=5):
    ...
    # --- 1. Mean calculation section (unchanged) ---
    ...
    with pd.option_context(
            ...
            'display.width', 1000,  # Increase width to accommodate all columns
            'display.max_columns', None  # Core change: do not limit the number of displayed columns
    ):
        print(grouped_means)
    print("\n" + "=" * 80 + "\n")

    # --- 2. Modified Mann-Whitney U test section ---
    test_cols = [
...
if __name__ == "__main__":
    ...
    # Call function, specify baseline group as 5
